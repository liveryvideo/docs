...
| Amazon        | Show a product                      | Custom size (Width: 80%, 27%). Positioning: Vertical bottom, Horizontal center.| 1. To embed an ad from these platforms, use Iframely:  2. Go to Iframely and create an account. 3. Paste the product link into Iframely. 4. 5. Add "https://" to the beginning of the link if it's missing. Click "Make it a small card" and copy the link from the embed code.|
