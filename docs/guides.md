...
| Spotify       | Share an album or playlist          | Custom size (Width: 80%, Height: 30%). Positioning: Vertical bottom, Horizontal center. | 1. Click on the three dots on the playlist or album.                                                                                                                                          |
|               |                                     |                                                                                         | 2. Choose "Share" and then "Embed Playlist."                                                                                                                                                  |
|               |                                     |                                                                                         | 3. Click "Show code" and copy the link from the generated iframe code.                                                                                                                        |
| Spotify       | Share a song                        | Custom size (Width: 80%, Height: 30%). Positioning: Vertical bottom, Horizontal center. | 1. Click on the three dots next to the song.                                                                                                                                                  |
|               |                                     |                                                                                         | 2. Choose "Share" and then "Embed Track."                                                                                                                                                     |
|               |                                     |                                                                                         | 3. Follow the same steps as for an album or playlist.                                                                                                                                         |
...
| Amazon        | Show a product                      | Custom size (Width: 80%, 27%).                                                          | 1. To embed an ad from these platforms, use Iframely:                                                                                                                                         |
|               |                                     |  Positioning: Vertical bottom, Horizontal center.                                       | 2. Go to Iframely and create an account.                                                                                                                                                      |
|               |                                     |                                                                                         | 3. Paste the product link into Iframely.                                                                                                                                                      |
|               |                                     |                                                                                         | 4. Click "Make it a small card" and copy the link from the embed code.                                                                                                                        |
|               |                                     |                                                                                         | 5. Add "https://" to the beginning of the link if it's missing.                                                                                                                               |
| Bol.com       | Show a product                      | Custom size (Width: 80%, 35%).                                                          | See Amazon description                                                                                                                                                                        |
|               |                                     | Positioning: Vertical bottom, Horizontal center.                                        |                                                                                                                                                                                               |
| Marktplaats   | Show a product                      | Custom size (Width: 80%, 78%).                                                          | See Amazon description                                                                                                                                                                        |
|               |                                     | Positioning: Vertical bottom, Horizontal center.                                        |                                                                                                                                                                                               |
| Ebay          | Show a product                      | Custom size (Width: 80%, 32%).                                                          | See Amazon description                                                                                                                                                                        |
|               |                                     | Positioning: Vertical bottom, Horizontal center.                                        |                                                                                                                                                                                               |
| Etsy          | Show a product                      | Custom size (Width: 80%, 25%).                                                          | See Amazon description                                                                                                                                                                        |
|               |                                     | Positioning: Vertical bottom, Horizontal center.                                        |                                                                                                                                                                                               |
...
| Twitter       | Show a tweet                        | Small size.                                                                             | Click on the three dots on the right side of the tweet, select "Embed," and copy the link from the embed code.                                                                                |
|               |                                     | Positioning: Vertical bottom, Horizontal center.                                        |                                                                                                                                                                                               |
| Apple Music   | Share an album or playlist          | Custom size (Width: 80%, Height: 60%).                                                  | 1. Click on the three dots next to the playlist or album.                                                                                                                                     |
|               |                                     | Positioning: Vertical bottom, Horizontal center.                                        | 2. Choose "Share" and then "Copy Embed code."                                                                                                                                                 |
|               |                                     |                                                                                         | 3. Paste the code into a document and copy the link from it.                                                                                                                                  |
| Apple Music   | Share a song                        | Custom size (Width: 80%, Height: 30%).                                                  | 1. Click on the three dots next to the song.                                                                                                                                                  |
|               |                                     | Positioning: Vertical bottom, Horizontal center.                                        | 2. Choose "Share" and then "Copy Embed code."                                                                                                                                                 |
|               |                                     |                                                                                         | 3. Follow the same steps as for an album or playlist.                                                                                                                                         |
